      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if ($_SESSION["status"] == "admin") { ?>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url('pemeriksaan/laporan'); ?>"><i class="fa fa-circle-o"></i>Pemeriksaan</a></li>
              <li><a href="<?= base_url('data_pasien/laporan'); ?>"><i class="fa fa-circle-o"></i>Data Pasien</a></li>
              <li><a href="<?= base_url('data_obat/laporan'); ?>"><i class="fa fa-circle-o"></i>Data Obat</a></li>
              <li><a href="<?= base_url('resep_obat/laporan'); ?>"><i class="fa fa-circle-o"></i>Data Resep</a></li>
              <li><a href="<?= base_url('pembayaran/laporan'); ?>"><i class="fa fa-circle-o"></i>Data Pembayaran</a></li>
              <li><a href="<?= base_url('obat_masuk/laporan'); ?>"><i class="fa fa-circle-o"></i>Data Obat Masuk</a></li>
            </ul>
          </li><?php  } ?>
        <!--   <?php if ($_SESSION["status"] == "admin") { ?>
        <li>
